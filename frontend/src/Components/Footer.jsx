...
class Footer extends React.Component {
    ...
    fetchData = () => {
        axios.get('http://localhost:4001/api/footer')
            .then(response => {
    ...
    render() {
        const { data } = this.state; // Extraer los datos del estado
        return (
            <footer>
                <div className="container pt-5">
                    <div className="row justify-content-center">
                        <div className="col-sm-6 col-md">
                            <a href="/" className="d-flex align-items-center mb-3 link-body-emphasis text-decoration-none">
                                <img src={`../images/general/${data.image}`} alt="Trabook logo" />
                            </a>
                            <p className="text-body-secondary">{data.slogan}</p>
                            <div className="social-media d-flex gap-3 pt-2 pb-1 justify-content-start">
                                <a href="#" className="btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-facebook" viewBox="0 0 16 16">
                                        <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951" />
                        ...
                        <div className="col-sm-6 col-md mb-4">
                            ...
                            <ul className="nav flex-column">
                                <li className="nav-item mb-2">
                                    <a href="#" className="nav-link p-0 text-body-secondary">{data.company_item_1}</a>
                                </li>
                                <li className="nav-item mb-2">
                                    <a href="#" className="nav-link p-0 text-body-secondary">{data.company_item_2}</a>
                                </li>
                                <li className="nav-item mb-2">
                                    <a href="#" className="nav-link p-0 text-body-secondary">{data.company_item_3}</a>
                                </li>
                                <li className="nav-item mb-2">
                                    <a href="#" className="nav-link p-0 text-body-secondary">{data.company_item_4}</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-sm-6 col-md mb-4">
                            ...
                            <ul className="nav flex-column">
                                <li className="nav-item mb-2">
                                    <a href="#" className="nav-link p-0 text-body-secondary">{data.contact_item_1}</a>
                                </li>
                                <li className="nav-item mb-2">
                                    <a href="#" className="nav-link p-0 text-body-secondary">{data.contact_item_2}</a>
                                </li>
                                <li className="nav-item mb-2">
                                    <a href="#" className="nav-link p-0 text-body-secondary">{data.contact_item_3}</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-sm-6 col-md mb-4">
                            ...
                            <ul className="nav flex-column">
                                <li className="nav-item mb-2">
                                    <a href="#" className="nav-link p-0 text-body-secondary">{data.more_item_1}</a>
                                </li>
                                <li className="nav-item mb-2">
                                    <a href="#" className="nav-link p-0 text-body-secondary">{data.more_item_2}</a>
                                </li>
                                <li className="nav-item mb-2">
                                    <a href="#" className="nav-link p-0 text-body-secondary">{data.more_item_3}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
