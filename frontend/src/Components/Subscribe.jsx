    ...
    return (
        <div className="container" id="subscribe-box">
            <div className="col-md-6">
                <h1 className="col-md-12 pb-5">{props.title}</h1>
                <div className="input-group position-relative">
                    <span className="input-group-text border border-0 bg-white ps-3"><img src={require(`../images/img/${props.image}`)} alt="Email icon" /></span>
                    ...
                    <button className="btn btn-outline-secondary position-absolute top-0 end-0 mx-2 mt-3 border-0 fs-6" type="button" id="button-suscribe">{props.text}</button>
                </div>
            </div>
